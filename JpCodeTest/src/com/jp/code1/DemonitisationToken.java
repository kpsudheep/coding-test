...
public class DemonitisationToken {
	...
	public static void main(String[] args) {
		...
		System.out.println("Max Amount: " + getMaxAmountFromToken(846523423)); //0<n<=1000000000
	...
	public static int getMaxAmountFromToken(int tokenValue) {
		...
		if (tokenValue % 2 == 0 || tokenValue % 3 == 0) {
			return tokenValue; // its safe to say you can get two n/2 tokens and three n/3 tokens if divisible by 2 or 3 respectively for maximum profit.
		} else { 
